...
<aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="https://www.24x7cloudservermanagement.com/wp-content/uploads/photo-150x150.png" alt="User Image" style="width: 70px;height: 70px">
        <div>
          <p class="app-sidebar__user-name"><c:out value="${loggedin}"/></p>
        </div>
      </div>
      <ul class="app-menu">
